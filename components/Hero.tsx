...
export default function Hero() {
  ...
  return (
    <section
      className="relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden px-4"
    ...
    >
      <div className="absolute inset-0" aria-hidden>
        <Image
          ...
          priority
          placeholder="blur"
          blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/P0BxYQAAAABJRU5ErkJggg=="
      ...
      {!reducedMotion && !playing && (
        <button
          ...
          className="absolute inset-0 z-10 flex items-center justify-center bg-black/40 text-white focus-visible:ring-2 focus-visible:ring-gold-500"
        >
          <svg
